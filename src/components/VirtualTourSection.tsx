        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative group">
            <div className="rounded-2xl overflow-hidden shadow-strong">
              <iframe src="https://www.google.com/maps/embed?pb=!4v1676700445847!6m8!1m7!1sCAoSK0FGMVFpcE1fZk9JbDNFTnlDcWtGaF9aeVlFQkhZMXVuZDdaTDZiTXNZMEk.!2m2!1d40.369633782371!2d-111.78566390675!3f163.61!4f-13.150000000000006!5f0.5970117501821992" width="100%" height="500" style={{
              border: 0
            }} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="w-full h-[500px]" />
            </div>
          ...
          <div className="text-center mt-8">
            <Button variant="cta" size="lg" className="btn btn-1 hover-filled-slide-down bg-teal-700 hover:bg-teal-600">
